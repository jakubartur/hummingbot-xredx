...
from hummingbot.connector.exchange.xredx.xredx_api_user_stream_data_source import \
...
class XredxUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self,
                 ...
                 xredx_auth: Optional[XredxAuth] = None,
                 trading_pairs: Optional[List[str]] = None):
        self._xredx_auth: XredxAuth = xredx_auth
        self._trading_pairs: List[str] = trading_pairs or []
        self._throttler = throttler or AsyncThrottler(Constants.RATE_LIMITS)
        super().__init__(data_source=XredxAPIUserStreamDataSource(
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        ...
        *required
        ...
        if not self._data_source:
            self._data_source = XredxAPIUserStreamDataSource(
                throttler=self._throttler,
                xredx_auth=self._xredx_auth,
                trading_pairs=self._trading_pairs
            )
