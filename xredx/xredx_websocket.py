...
from hummingbot.connector.exchange.xredx.xredx_utils import RequestId
...
class XredxWebsocket(RequestId):
    ...
    def __init__(self,
                 auth: Optional[XredxAuth] = None,
                 throttler: Optional[AsyncThrottler] = None):
        self._auth: Optional[XredxAuth] = auth
