...
import conf
from hummingbot.connector.exchange.xredx.xredx_exchange import XredxExchange
...
class XredxExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.connector: XredxExchange = XredxExchange(
            xredx_api_key=API_KEY,
            xredx_secret_key=API_SECRET,
            trading_pairs=[cls.trading_pair],
            trading_required=True
        )
        print("Initializing Xredx market... this will take about a minute.")
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            self.event_logger.clear()
            new_connector = XredxExchange(API_KEY, API_SECRET, [self.trading_pair], True)
            for event_tag in self.events:
