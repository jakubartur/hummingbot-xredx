...
class XredxConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="xredx", client_data=None)
    xredx_api_key: SecretStr = Field(
        default=...,
    ...
    xredx_secret_key: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
