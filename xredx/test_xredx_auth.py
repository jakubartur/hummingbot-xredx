...
from hummingbot.connector.exchange.xredx.xredx_websocket import XredxWebsocket
from hummingbot.logger.struct_logger import METRICS_LOG_LEVEL
from hummingbot.connector.exchange.xredx.xredx_constants import Constants
from hummingbot.connector.exchange.xredx.xredx_utils import aiohttp_response_with_errors
...
class TestAuth(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        secret_key = conf.xredx_secret_key
        cls.auth = XredxAuth(api_key, secret_key)
