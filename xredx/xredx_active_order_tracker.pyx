...
XredxOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class XredxActiveOrderTracker:
    def __init__(self,
                 active_asks: XredxOrderBookTrackingDictionary = None,
                 active_bids: XredxOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> XredxOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> XredxOrderBookTrackingDictionary:
