...
from .xredx_auth import XredxAuth
from .xredx_websocket import XredxWebsocket


class XredxAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _listen_to_orders_trades_balances(self) -> AsyncIterable[Any]:
        ...
        try:
            self._ws = XredxWebsocket(self._xredx_auth, throttler=self._throttler)
