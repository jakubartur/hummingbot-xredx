...
class XredxOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[XredxOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: XredxOrderBookTracker = XredxOrderBookTracker(trading_pairs=cls.trading_pairs)
    ...
    def test_api_get_last_traded_prices(self):
        prices = self.ev_loop.run_until_complete(
            XredxAPIOrderBookDataSource.get_last_traded_prices(["BTC-USDT", "ROGER-BTC"]))
        print("\n")
